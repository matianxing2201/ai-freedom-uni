...
export function getEnvBaseUrl() {
  ...
  const VITE_SERVER_BASEURL__WEIXIN_DEVELOP = 'https://reno-admin.dermottech.com/'
  const VITE_SERVER_BASEURL__WEIXIN_TRIAL = 'https://reno-admin.dermottech.com/'
  const VITE_SERVER_BASEURL__WEIXIN_RELEASE = 'https://admin.aifreedomhome.com/'
